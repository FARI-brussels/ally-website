<template>
  <div class="main">
    ...
    <div
      class="categories-section bg-color-gray-light-mode-50 full-width-section"
      :class="{ 'categories-section-mobile': isMobile }"
    >
      <PageSection
      ...
      <div
        ...
        :class="{ 'categories-list-mobile': isMobile }"
      >
        <div
    ...
    <div class="cases-section">
      <div
        ...
        :class="{ 'cases-introduction-mobile': isMobile }"
      >
        <PageSection
...
const pageData = computed(
  (): { title: string; content: string[]; hero: HeroProps } => {
